...
export default async (req: NextApiRequest, res: NextApiResponse) => {
    if (req.method === 'POST') {
        ...
        const mailOptions = {
            ...
            subject: 'New Expert Form Submission', // Subject line
            html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9; border-radius: 10px;">
          <h2 style="text-align: center; color: #4CAF50;">New Expert Form Submission</h2>
          ...
          <p style="text-align: center; color: #999;">This email was sent from the expert modal form on your website.</p>
        </div>
      `,
        };
