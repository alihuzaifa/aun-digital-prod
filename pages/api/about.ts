...
export default async (req: NextApiRequest, res: NextApiResponse) => {
  if (req.method === "POST") {
    ...
    const { fullName, email, contact, message } = data;
    ...
    const mailOptions = {
      ...
      subject: "New About Form Submission", // Subject line
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9; border-radius: 10px;">
          <h2 style="text-align: center; color: #4CAF50;">New About Form Submission</h2>
          <p style="text-align: center; color: #555;">You have received a new message from your website About form.</p>
          ...
          <p style="text-align: center; color: #999;">This email was sent from the About form on your website.</p>
        </div>
      `,
    };
